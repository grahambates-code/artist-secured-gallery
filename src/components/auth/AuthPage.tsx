          ...
          <Card className="gallery-card bg-card/80 backdrop-blur-sm border border-border">
            ...
            <CardContent className="space-y-8 pt-0">
              <Button 
                ...
                className="w-full group relative overflow-hidden bg-transparent text-foreground border-2 border-border hover:bg-foreground hover:text-background font-light tracking-[0.1em] py-4 transition-all duration-300"
                variant="outline"
              >
